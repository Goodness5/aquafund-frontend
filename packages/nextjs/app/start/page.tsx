		...
		<div className="container mx-auto px-4 py-10">
			...
			<div className="bg-base-100 rounded-xl p-6 shadow-md max-w-xl">
				<div className="form-control gap-4">
					...
					<input className="input input-bordered" placeholder="0x..." value={admin} onChange={e => setAdmin(e.target.value)} />

					<label className="label">
						<span className="label-text">Funding Goal (BNB)</span>
					</label>
					<input className="input input-bordered" placeholder="10" value={goal} onChange={e => setGoal(e.target.value)} />

					<label className="label">
						<span className="label-text">Metadata Hash (bytes32 hex)</span>
					</label>
					<input className="input input-bordered" placeholder={zeroHash} value={meta} onChange={e => setMeta(e.target.value)} />
